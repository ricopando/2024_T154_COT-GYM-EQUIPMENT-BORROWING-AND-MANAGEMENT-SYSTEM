        ...
        setEquipmentDetails(prevDetails =>
          prevDetails.map(item =>
            item.id === selectedItem.itemId
              ? { ...item, borrowDate: newBorrowDate, returnDate: newReturnDate }
              : item
          )
        );
    ...
    },
    {
        ...
        selector: row => (
          <div className="flex gap-1">
            <button
              className="bg-primary text-white py-1 px-1 rounded hover:bg-primary-dark"
            ...
            <button
              className="bg-yellow-500 text-white py-1 px-1 rounded hover:bg-yellow-600"
