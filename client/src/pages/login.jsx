        ...
        <div className="relative overflow-hidden min-h-screen bg-gray-100 flex justify-center items-center dark:bg-slate-950 dark:text-white duration-200">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-8xl p-4 sm:p-20 min-h-[40vh] md:min-h-screen animate-fadeIn">
                <div className="relative z-10 max-w-4xl animate-slideIn flex-1 mb-6 md:mb-0">
                    <h3 className="font-bold mb-3 ml-3 text-primary text-left text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-shadow">
                        Gym Equipment Management and Borrowing System
                    </h3>
                    <p className="text-black text-left text-sm sm:text-base md:text-lg opacity-90 animate-fadeInDelayed ml-3">
                ...
                <div className="bg-white dark:bg-gray-800 dark:hover:bg-primary hover:text-white relative shadow-lg duration-300 group max-w-md w-full mx-4 rounded-2xl p-5 transition-transform transform hover:-translate-y-1 hover:shadow-2xl flex-1">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-6 text-primary group-hover:text-primary flex items-center justify-center">
                        <CgGym size="40" />
                        GEMS
                    </h1>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 text-black ${emailError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'}`}
                                value={email}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                aria-label="Password"
                                className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 text-black ${passwordError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'}`}
                                value={password}
                        ...
                        <button
                            type="submit"
                            className={`w-full py-3 mt-6 h-12 text-white font-bold rounded-lg ${loading ? 'bg-primary' : 'bg-primary hover:bg-blue-700'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                            disabled={loading}
                        >
