  ...
  const handlePrint = () => {
    ...
    filteredItems.forEach((item) => {
      ...
      if (
        ...
        equipmentTable.style.cssText =
          "width: 100%; border-collapse: collapse; margin: 8px 0; background-color: #f8f9fa;";
        ...
        equipmentTable.innerHTML = `
          ...
          ${item.equipment
            .map(
              (equip) => `
            <tr>
              <td style="border: 1px solid #ddd; padding: 6px; width: 14%;">${
                equip.equipment.name
              }</td>
              <td style="border: 1px solid #ddd; padding: 6px; width: 14%;">${
                equip.equipment.serialNumber
              }</td>
              <td style="border: 1px solid #ddd; padding: 6px; width: 14%;">${
              ...
              <td style="border: 1px solid #ddd; padding: 6px; width: 15%;">${new Date(
                equip.borrowDate
              ).toLocaleDateString()}</td>
              <td style="border: 1px solid #ddd; padding: 6px; width: 15%;">${new Date(
                equip.returnDate
